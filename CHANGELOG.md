...
1. **README.md** - 添加卸载说明
2. **README_CN.md** - 添加卸载说明（中文）
3. 更新文件列表

### 🐛 Bug 修复

1. **Node.js 路径检测改进**
   - 修复 fnm current 输出格式问题
   - 添加后备检测机制
   - 提高路径检测成功率
...
| 阶段 | 工具 | 状态 |
|------|------|------|
| 部署 | openclaw-deploy.sh | ✅ |
| 部署 | openclaw-deploy-macos.sh | ✅ |
| 部署 | docker-compose.yml | ✅ |
| 故障排查 | openclaw-troubleshoot.sh | ✅ |
| 卸载 | openclaw-uninstall.sh | ✅ |
| 卸载 | docker-uninstall.sh | ✅ |
